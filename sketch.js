...
var shootingSound,GameoverSound;
...
function preload(){
  ...
  GameOverImg = loadImage("game_ove.png");
...
function setup() {
  ...
  yay = createSprite(700, 650, 50, 50);
  yay.addImage(yayImg);
  yay.scale = 0.6;
  yay.visible = false;
...
//Displaying instructions  
  ...
  text("4. Refresh the page to start again once the game is over",100,500);
